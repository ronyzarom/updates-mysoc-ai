...
DEST=P('/usr/local/lib/siemcore-policy-consumer/1.16.1.20');WRAPPER=P('/usr/local/sbin/siemcore-apply-update')
POLICY=P('/etc/siemcore-cascade-updater/recovery-policy.json')
BASELINE='ed4622f1cacb6aecac49687a87b30ba2dee3e3d7ba4c9627d55d7cd3290105a2'
def require(ok,msg):
